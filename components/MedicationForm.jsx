  ...
  return (
    ...
    >
      ...
      <div>
        ...
        {times.map((time, index) => (
          <div key={index} style={{ display: "flex", gap: "10px", marginTop: "5px" }}>
            ...
            />
            {times.length > 1 && (
              <button type="button" onClick={() => removeTime(index)} style={{ padding: "5px 10px", backgroundColor: "#f44336", color: "#fff", border: "none", borderRadius: "5px", cursor: "pointer" }}>
                Remove
              </button>
            )}
          </div>
        ))}
        <button type="button" onClick={addTime} style={{ marginTop: "5px", padding: "8px 12px", backgroundColor: "#2196F3", color: "#fff", border: "none", borderRadius: "5px", cursor: "pointer" }}>
          Add Time
        </button>
      </div>
      ...
      <div style={{ display: "flex", gap: "10px" }}>
        ...
        {onCancel && (
          <button type="button" onClick={onCancel} style={{ flex: 1, padding: "12px", backgroundColor: "#f44336", color: "#fff", border: "none", borderRadius: "5px", cursor: "pointer" }}>
            Cancel
          </button>
        )}
      </div>
